 ...
 * @author user
 */
public class pat_actividad extends Pantalla {
 ...
 //   private Grupo gru_pantalla = new Grupo();
    ...
    public pat_actividad() {
        ...
        tab_tabla.setTabla("pat_actividad", "ide_pat_actividad", 1);
        tab_tabla.setNumeroTabla(1);
        tab_tabla.dibujar();
        tab_tabla.getColumna("pat_ide_pat_actividad").setCombo("select ide_pat_actividad,detalle_actividad from pat_actividad where nivel=1;");
         tab_tabla.getColumna("pat_ide_pat_actividad").setAutoCompletar(); 
