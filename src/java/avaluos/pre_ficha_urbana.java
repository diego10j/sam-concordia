 ...
 * @author user
 */
public class pre_ficha_urbana extends Pantalla{
    ...
    private Tabla tab_lotes = new Tabla();
...
///busqueda
    ...
    public pre_ficha_urbana() {
        ...
        pat_panel3.setPanelTabla(tab_area);
        tab_tabulador.agregarTab("AREA", pat_panel3);
        ...
        tab_lotes.setId("tab_lotes");
        tab_lotes.setIdCompleto("tab_tabulador:tab_lotes");
        PanelTabla pat_panel1 = new PanelTabla();
        pat_panel1.setPanelTabla(tab_lotes);
        tab_tabulador.agregarTab("LOTE TIPO", pat_panel1);
        ...
        sql = " SELECT s.ide_distribucion,s.des_distribucion  FROM  inst_distribucion_politica s ,inst_distribucion_politica z,inst_distribucion_politica p,inst_distribucion_politica c,inst_distribucion_politica pr "
        ...
        tab_tabla.getColumna("NIVEL").setMetodoKeyPress("formarClave");
        tab_tabla.getColumna("BLOQUE").setMetodoKeyPress("formarClave");
        tab_tabla.getColumna("UNIDAD").setMetodoKeyPress("formarClave");
        tab_tabla.getColumna("FECHA_FICHA").setValorDefecto(utilitario.getFechaActual());
        tab_tabla.setBusquedaFormulario(false);
        tab_tabla.agregarRelacion(tab_lotes);
        ...
        tab_tabla.getColumna("bloque").setLectura(true);
        tab_tabla.getColumna("nivel").setLectura(true);
        //publico_privado
        List lis_tipos = new ArrayList();
        Object obj1[] = {"1", "PÚBLICO"};
        Object obj2[] = {"2", "PRIVADO"};
        lis_tipos.add(obj1);
        lis_tipos.add(obj2);
        tab_tabla.getColumna("publico_privado").setRadio(lis_tipos, "1");
        tab_tabla.dibujar();
        ...
        eti_titulo.setValue("FICHA DE RELEVAMIENTO PREDIAL URBANO");
        ...
        ////tabla lotes
        tab_lotes.setTabla("sigt_lote", "ide_lote", 2);
        tab_lotes.getColumna("ide_lote_tipo").setCombo("valc_lote_tipo", "ide_lote_tipo", "area_homogenea,frente,fondo", "");
        tab_lotes.getColumna("ide_lote_tipo").setAutoCompletar();
        tab_lotes.dibujar();

        ////tabla del dominio
        tab_dominio.setTabla("sigt_titular_dominio", "ide_titular", 3);
        tab_dominio.getColumna("ide_predio_rural").setVisible(false);
        ...
        ////tabla de areas
        tab_area.setTabla("sigt_area_terreno", "ide_area_terreno", 4);
        tab_area.getColumna("ide_localizacion").setCombo("sigt_localizacion", "ide_localizacion", "codigo,detalle", "urbano=true");
        tab_area.getColumna("ide_medida").setCombo("valc_medida", "ide_medida", "des_medida", "");
        tab_area.getColumna("ide_caracteristica_suelo").setCombo("sigt_caracteristicas_suelo", "ide_caracteristica_suelo", "codigo,detalle", "");
        tab_area.getColumna("ide_drenaje").setVisible(false);
        tab_area.getColumna("ide_erosion").setVisible(false);
        tab_area.getColumna("ide_riesgo").setVisible(false);
        tab_area.getColumna("ide_topografia").setCombo("sigt_topografia", "ide_topografia", "codigo,detalle", "urbano=true");
        tab_area.getColumna("ide_predio_rural").setVisible(false);
        ...
        ////tabla documentacion
        tab_documentacion.setTabla("sigt_documentacion", "ide_documentacion", 5);
        ...
        tab_documentacion.getColumna("ide_predio_rural").setVisible(false);
        ...
        tab_construccion.setTabla("sigt_construccion", "ide_construccion", 6);
        tab_construccion.getColumna("ide_predio_rural").setVisible(false);
        ...
        ////tabla servicios
        tab_servicios.setTabla("sigt_servicios_predio", "ide_servicio_predio", 7);
        tab_servicios.getColumna("ide_predio_rural").setVisible(false);
        ...
        ////tabla adicionales
        tab_adicionales.setTabla("sigt_adicionales_constructivos", "ide_adicional", 8);
        tab_adicionales.getColumna("ide_predio_rural").setVisible(false);
        ...
        ////tabla control
        tab_control.setTabla("sigt_ficha_control", "ide_ficha_control", 9);
        ...
        aut_distribucion.setAutoCompletar("SELECT b.ide_distribucion,b.des_distribucion,s.des_distribucion,z.des_distribucion,p.des_distribucion ,c.des_distribucion,pr.des_distribucion    FROM  inst_distribucion_politica b,inst_distribucion_politica s ,inst_distribucion_politica z,inst_distribucion_politica p,inst_distribucion_politica c,inst_distribucion_politica pr "
                + " WHERE b.ide_tipo_distribucion=7 "
                + "and b.ins_ide_distribucion=s.ide_distribucion "
                + "and s.ins_ide_distribucion=z.ide_distribucion "
                + "and z.ins_ide_distribucion=p.ide_distribucion "
...
//        tab_cambio.setRows(8);
        ...
        tab_nuevo.setTabla("sigt_titular_dominio", "ide_titular", 3);
        tab_nuevo.getColumna("ide_predio_rural").setVisible(false);
        ...
        tab_nuevo.setCondicion("ide_predio=-1");
        tab_nuevo.dibujar();
        tab_nuevo.setCondicion("");
        PanelTabla pat_panel12 = new PanelTabla();
        pat_panel12.setPanelTabla(tab_nuevo);
        pat_panel12.getMenuTabla().getItem_guardar().setRendered(false);
        gri_cambio.getChildren().add(pat_panel12);
        ...
        tab_busca_titulo.setSql("SELECT ide_predio,nombre,numero,clave from  sigt_predio where ide_predio=-1");
        ...
        rep_reporte.getBot_aceptar().setUpdate("sfr_formato,rep_reporte");
        sfr_formato.setId("sfr_formato");

        gru_pantalla.getChildren().add(rep_reporte);
        gru_pantalla.getChildren().add(sfr_formato);
    ...
    public void aceptar_reporte() {
            ...
            if (rep_reporte.getReporteSelecionado().equalsIgnoreCase("Ficha Urbana")) {
                rep_reporte.cerrar();
    ...
    public void bloquearCampos(boolean estado) {
        tab_tabla.getColumna("bloque").setLectura(estado);
        tab_tabla.getColumna("nivel").setLectura(estado);
        utilitario.addUpdateTabla(tab_tabla, "bloque,nivel", "");
    }
    ...
    public void aceptaBuscar() {
        if (tab_busca_titulo.getValorSeleccionado() != null) {
            tab_tabla.setCondicion("ide_predio=" + tab_busca_titulo.getValorSeleccionado());
            tab_tabla.setCondicionBuscar("");
            tab_tabla.ejecutarSql();
            tab_tabla.actualizarRelaciones();
            tab_tabla.setCondicion("");
            dia_dialogo.cerrar();
            utilitario.addUpdate("tab_tabla,tab_tabulador:tab_lotes,tab_tabulador:tab_dominio,tab_tabulador:tab_area,tab_tabulador:tab_documentacion,tab_tabulador:tab_construccion,tab_tabulador:tab_servicios,tab_tabulador:tab_adicionales,tab_tabulador:tab_control,tab_tabulador:tab_foto,tab_tabulador:tab_croquis,tab_nuevo,dia_dialogo");
        }
    }

    public void busca_Ficha(SelectEvent evt) {
        auc_cliente.onSelect(evt);
        tab_busca_titulo.setSql("SELECT ide_predio,nombre,numero,clave from  sigt_predio where ide_predio=" + auc_cliente.getValor());
    ...
    public void cambiarDominio() {
        if (tab_tabla.getTotalFilas() > 0 && !tab_tabla.isFilaInsertada() && tab_dominio.getTotalFilas() > 0) {
            tab_cambio.setSql("select ide_titular,nombre,des_tipo_documento,cedula,porcentaje from sigt_titular_dominio,rec_clientes,sigc_tipo_documento where  rec_clientes.ide_cliente =sigt_titular_dominio.ide_cliente  and rec_clientes.ide_tipo_documento=sigc_tipo_documento.ide_tipo_documento and ide_predio=" + tab_tabla.getValor("ide_predio"));

            tab_cambio.ejecutarSql();
            tab_nuevo.getColumna("ide_predio").setValorDefecto(tab_tabla.getValor("ide_predio"));
            tab_nuevo.limpiar();
            dia_cambio.dibujar();
        } else {
    ...
    public void seleccionarTipoPropiedad(AjaxBehaviorEvent evt) {
        ...
        if (tab_tabla.getValor("IDE_TIPO_PROPIEDAD").equals("1")) {
            bloquearCampos(true);
        } else {
        ...
        if (!tab_tabla.isFilaInsertada()) {
            if (!sec_calendario.isVisible()) {
                ...
                if (utilitario.isFechaValida(sec_calendario.getFecha1String())) {
                    ...
                    cls_avaluar.avaluarConstruccionUrbana(tab_tabla.getValorSeleccionado(), sec_calendario.getFecha1String());
    ...
    public void aceptarAvaluarVarios() {
        ...
        if (!str_avaluar_varios.isEmpty()) {
            if (cal_avalua.getDate() != null) {
                List lis = utilitario.getConexion().consultar("SELECT IDE_PREDIO FROM sigt_predio where " + str_avaluar_varios);
                cls_avaluos cls_avaluar = new cls_avaluos();
                if (!lis.isEmpty()) {
                    for (int i = 0; i < lis.size(); i++) {
                        cls_avaluar.avaluarConstruccionUrbana(lis.get(i) + "", cal_avalua.getFecha());
                    }
    ...
    public boolean validar() {
        ...
        //    if (str_clave != null && str_clave.length() == 25) {
    ...
    public Tabla getTab_lotes() {
        return tab_lotes;
    }

    public void setTab_lotes(Tabla tab_lotes) {
        this.tab_lotes = tab_lotes;
    }
