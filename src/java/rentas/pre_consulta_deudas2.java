 ...
 * @author HP
 */
public class pre_consulta_deudas2 extends Pantalla {
   ...
   // private Grupo gru_pantalla = new Grupo();
    ...
    public pre_consulta_deudas2() {
        ...
        tab_busca_titulo.setSql("select ide_titulo,ide_estado,des_ingreso,valor,num_titulo,fecha_pago from tes_ingreso where ide_titulo=-1");
        ...
        tab_busca_titulo2.setSql("select ide_titulo,ide_estado,des_ingreso,valor,num_titulo,fecha_pago from tes_ingreso where ide_titulo=-1");
        tab_busca_titulo2.setRows(10);
        ...
        tab_tabla1.setSql("select ide_titulo,detalle,des_ingreso,valor,num_titulo,fecha_pago from tes_ingreso  ,rec_estados  "
   ...
   /* public Barra getBar_botones() {
    ...
    public void aceptaanular() {
        ...
        if (tab_busca_titulo.getValor("ide_titulo") != null) {
            if (estado.equals("2")) {
                if (fecha.equals(utilitario.getFechaActual())) {
                    if (tex.getValue() != null) {
                        ...
                        dia_dialogo.cerrar();
                    } else {utilitario.agregarMensajeInfo("Escriba la razon de la baja", "EN EL CAMPO RAZON DIGITE LA RAZON DE LA BAJA");}
                } else {utilitario.agregarMensajeInfo("IMPOSIBLE ANULAR", "El titulo esta pagado y la vigencia para anular ha caducado");}
            ...
            } else if (estado.equals("3")) {utilitario.agregarMensajeInfo("Ya esta anulado", " El TITULO YA SE ENCUENTRA ANULADO");}
        } else {utilitario.agregarMensajeInfo("no Hay titulo Seleccionado", " POR FAVOR SELECCIONE EL TITULO A ANULAR");}
