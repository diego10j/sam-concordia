 ...
 * @author HP
 */
public class trans_modelos  extends Pantalla{
    ...
    public trans_modelos() {
        ...
        tab_tabla1.setTabla("trans_modelos", "ide_modelo", 1);
        tab_tabla1.getColumna("ide_marca").setCombo("select ide_marca,marca from trans_marcas order by marca;");
        tab_tabla1.getColumna("ide_marca").setAutoCompletar();
